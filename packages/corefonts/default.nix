# this is a version of corefonts from nixpkgs with macOS APFS casing fix applied
...
stdenv.mkDerivation {
  ...
  buildCommand = ''
    ...
    mv arial.ttf     Arial_Regular.ttf
